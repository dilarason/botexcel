...
// Şimdilik placeholder componentler (ileride detaylandıracağız)
function FileUpload() {
  return <button className="bg-blue-500 text-white px-6 py-2 rounded-xl">Dosya Yükle</button>;
}
function DemoMode() {
  return <button className="bg-green-500 text-white px-6 py-2 rounded-xl">Demo Modu</button>;
}
function PlusMode() {
  return <button className="bg-yellow-500 text-white px-6 py-2 rounded-xl">BotExcel Plus</button>;
}
